...
import { ImmutableZone } from "./ImmutableZone.sol";
...
/**
 * @title  ImmutableZoneController
 * @author Immutable
 * @notice ImmutableZoneController enables deploying, pausing and executing
 *         orders on the ImmutableZone. This deployer is designed to be owned
 *         by a gnosis safe, DAO, or trusted party. This is based on the
 *         PausableZoneController in the official Seaport repository.
 */
contract ImmutableZoneController is
    PausableZoneControllerInterface,
    PausableZoneEventsAndErrors
{
    // Set the owner that can deploy, pause and execute orders on ImmutableZone.
    ...
    constructor(address ownerAddress) {
        ...
        zoneCreationCode = keccak256(type(ImmutableZone).creationCode);
    }

    /**
     * @notice Deploy a ImmutableZone to a precomputed address.
     *
    ...
    function createZone(
        ...
        // Derive the ImmutableZone address.
    ...
    function pause(
        ...
        ImmutableZone(zone).pause(msg.sender);
     ...
     *
     * @param immutableZoneAddress The zone that manages the
     * orders to be cancelled.
     * @param seaportAddress      The Seaport address.
     * @param orders              The orders to cancel.
     */
    function cancelOrders(
        address immutableZoneAddress,
        ...
        ImmutableZone zone = ImmutableZone(immutableZoneAddress);
     ...
     *
     * @param immutableZoneAddress The zone that manages the orders
     * to be cancelled.
     * @param seaportAddress      The Seaport address.
     ...
     *         zone.
     *
     * @param immutableZoneAddress The zone that manages the orders to be
     *                            cancelled.
     * @param seaportAddress      The Seaport address.
     * @param orders              The orders to match.
     ...
     *         given zone.
     *
     * @param immutableZoneAddress The zone address to assign operator role.
