    ...
    PausableZoneInterface
{
    ...
    // The operator doubles as the authorised Immutable signer.
    ...
    function validateOrder(
        ...
        // generate messageHash from orderHash
        ...
        // recover signer address from signature in `extraData`
        address signer = ECDSA.recover(messageHash, zoneParameters.extraData);

        // if the recovered signer address has operator role, return magic value
        validOrderMagicValue = signer == operator
